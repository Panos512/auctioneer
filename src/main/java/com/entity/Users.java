...
public class Users {
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(users.buyerRating, buyerRating) != 0) return false;
        if (Double.compare(users.sellerRating, sellerRating) != 0) return false;
        if (Double.compare(users.latitude, latitude) != 0) return false;
        if (Double.compare(users.longitude, longitude) != 0) return false;
        if (verified != users.verified) return false;
    ...
    public int hashCode() {
        ...
        temp = Double.doubleToLongBits(buyerRating);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = Double.doubleToLongBits(sellerRating);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
